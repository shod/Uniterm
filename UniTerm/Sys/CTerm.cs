    ...
    class CTerm
    {
       ...
       /// <summary>
        ...
        public String getDataString()
        {
            ...
            String strAdd = "";
            retData = _TermId.ToString() + sep + _RequestParam.ProtocolIndex + sep + DateTime.Now.Hour + ":" + DateTime.Now.Minute + ":" + DateTime.Now.Second;
        ...
        {
            if (ResData.strDataOriginal.Length > 0)
            {
